...
// 
// Fill the settings and install this tag in GTM via All Pages trigger

(function() {
    // Fill the settings
    var settings = {
        // Pixels you want to send data to 
        pixels: {
            vk: true,
            facebook: true,
            myTarget: true
        ...
        // VK pixel settings
        vk: {
            // Pixel ID. Even if there is only one pixel, you must specify its ID in the array
            pixelIDs: ['vk_pixel_id_1', 'vk_pixel_id_2'],
            // If you want to use several price lists, set the value to true, otherwise set false
            fewPriceLists: true,
            // Price list ID if you want yo use one price list
            priceListId: 1234,
            // Dictionary "host - price list ID", if you want to use several price lists
            priceListIds: {
                'moscow.example.ru': 1111,
                'spb.example.ru': 2222
            },
            // Install VK pixel base code. If a VK pixel(s) is(are) already installed on the site, installation of the base code isn't required
            baseCode: true,
            // Default currency
            defaultCurrency: 'RUB'
        },
        ...
        facebook: {
            // Pixel ID. Even if there is only one pixel, you must specify its ID in the array
            pixelIDs: ['facebook_pixel_id_1', 'facebook_pixel_id_2'],
            // Install Facebook pixel base code. If a Facebook pixel(s) is(are) already installed on the site, installation of the base code isn't required
            baseCode: true,
            // Default currency
            defaultCurrency: 'RUB'
        },
    
        // myTarget counter settings
        myTarget: {
            // Pixel ID. Even if there is only one pixel, you must specify its ID in the array
            pixelIDs: ['myTarget_counter_id_1', 'myTarget_counter_id_2'],
            // If you want to use several price lists, set the value to true, otherwise set false
            fewPriceLists: true,
            // Price list ID if you want yo use one price list
            priceListId: '111',
            // Dictionary "host - price list ID", if you want to use several price lists
            priceListIds: {
                'moscow.example.ru': '111',
                'spb.example.ru': '222'
            },
            // Install myTarget counter base code. If a myTarget counter(s) is(are) already installed on the site, installation of the base code isn't required
            baseCode: true
        },
        ...
        pageTypeGTMnames: {
            ...
            main: 'example_main_page',
            // GTM page type variable value(s) for the catalog site page(s). Even if there is only one catalog page value, you must specify it in the array
            catalog: ['example_catalog_page_1', 'example_catalog_page_2'],
            // GTM page type variable value for the site search page of the site
            siteSearch: 'example_siteSearch_page'
        },

        // If the page type is NOT passed from the site to a GTM variable, you should to set regular expressions that identifies the site pages
        // Regular expression that identifies the home site page
        mainPage: 'example\\.ru\\/($|\\?)',
        // Regular expression that identifies the catalog site page(s)
        catalogPage: 'example\\.ru\\/catalog\\/',
        // Regular expression that identifies a site page with site search results
        siteSearch: 'search\\.html',
